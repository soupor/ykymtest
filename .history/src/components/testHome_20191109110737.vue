  ...
  <div class="testHome">
    <el-form ref="form" :model="form" label-width="100px">
      ...
      <el-form-item label="业务代码" class="item" >
        <el-select v-model="form.bizCode" placeholder="请选择发送方" @change="handleBizCode">
          <el-option lable="insureApply" value="雇主责任险" key=""></el-option>
    ...
    <el-form ref="form" :model="form" label-width="150px">
      ...
      <el-form-item label="省/市" class="item" >
        <area-select type='all' :level='1'  v-model="selected" :data="pca" @change="initAddress"></area-select>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    initAddress() {
      this.form.bizData.provinceCode = Object.keys(this.selected[0])
      this.form.bizData.cityCode =  Object.keys(this.selected[1])
      console.log("province",this.form.bizData.provinceCode)
      console.log("cityCode",this.form.bizData.cityCode)

    },
    initDate() {
      this.form.insStartData = insuranceDate[0],
      this.form.insEndDate = insuranceDate[1],
    }
  },
  watch: {

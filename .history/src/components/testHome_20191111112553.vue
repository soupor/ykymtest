    ...
    <el-form ref="form" :model="form" label-width="100px">
      ...
      <el-form-item label="业务代码" class="item" >
        <el-select v-model="form.bizCode" placeholder="请选择发送方" @change="handleBizCode">
          ...
          <el-option lable="insureStatus" value="insureStatus"></el-option>
          <el-option lable="insureFile" value="insureFile"></el-option>
          <el-option lable="invoiceApply" value="invoiceApply"></el-option>
        </el-select>
      </el-form-item>
    ...
    <div v-else-if="form.bizCode == 'insureStatus'">
      <el-form ref="form" :model="form" label-width="100px">
        ...
        <el-form-item label="是否请求电子保单文件" class="item" >
          <el-radio v-model="statusform.insuranceDate" label="1">是</el-radio>
          <el-radio v-model="statusform.insuranceDate" label="0">否</el-radio>
        </el-form-item>
      </el-form>
    </div>
    <div v-else-if="form.bizCode == 'applyNotify'">   
    </div>
    <el-button type="primary" @click="getSign" class="buttonPost" >获取签名</el-button>
    <el-button type="primary" @click="submit" class="buttonPost">提交</el-button>
  </div>
</template>
...
export default {
  ...
  destroyed () {
     ...
     console.log("statusform.needPolicyFile",this.statusform.needPolicyFile);
  },
  methods: {
    handleBizCode() {},
    initAddress() {

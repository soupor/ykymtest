    ...
    <div v-else-if="form.bizCode == 'insureFile'"> 
      <el-form ref="form" :model="form" label-width="100px">
        ...
        <el-form-item label="文件列表" class="item" >
          <el-upload
            class="upload-demo"
            :before-upload="beforeUpload(file, fileform.fileIdList)"
            action="http://192.168.1.133:10081/ykym/gateWay/uploadFile"
...
export default {
  ...
  methods: {
    ...
    beforeUpload(file, fileList) {
      ...
      let fd = new FormData()
      fd.append('key', file)
      axios.post("http://192.168.1.133:10081/ykym/gateWay/uploadFile", fd)
    },
    initAddress() {

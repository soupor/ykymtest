...
<script>
    export default {
        ...
        methods: {
            ...
            queRecordPage () {
                if(sessionStorage.getItem(`employeeListItem`)){
        ...
        created() {
            if(sessionStorage.getItem(`employeeList`)){
                this.tableData = JSON.parse(sessionStorage.getItem(`employeeList`))
        ...
        destroyed() {
            sessionStorage.setItem(`employeeList`, JSON.stringify(this.tableData));

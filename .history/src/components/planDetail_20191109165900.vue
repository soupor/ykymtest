...
export default {
    ...
    created() {
        if(sessionStorage.getItem(`planList`)){
            this.planList = JSON.parseJSON.parse(sessionStorage.getItem(`planList`))
        }
        if(sessionStorage.getItem(`planOptionList`)){
            this.planList.planOptionList = JSON.parseJSON.parse(sessionStorage.getItem(`planOptionList`))
        }
       
    },
    destroyed() {
       sessionStorage.setItem(`planList`,JSON.stringify(this.planList));
    },

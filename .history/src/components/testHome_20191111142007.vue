  ...
  <div class="testHome">
    ...
    <el-form ref="form" :model="form" label-width="150px">
      ...
      <el-form-item label="计费方法" class="item" >
        <el-select v-model="form.bizData.billingMode" placeholder="请选择计费方法" @change="handleBizCode">
          <el-option lable="按限额" value="quota" ></el-option>
          <el-option lable="按工资" value="salary" ></el-option>
        </el-select>
      </el-form-item>

...
<script>
    export default {
        ...
        methods: {
            ...
            queRecordPage () {
                if(sessionStorage.getItem(`planOptionListItem`)){
                    this.tableData.push(JSON.parse(sessionStorage.getItem(`planOptionListItem`)));
                }
        ...
        created() {
            if(sessionStorage.getItem(`planOptionList`)){
                this.tableData = JSON.parse(sessionStorage.getItem(`planOptionList`))
            }
        ...
        destroyed() {
            sessionStorage.setItem(`planOptionList`, JSON.stringify(this.tableData));
        }
    }
</script>